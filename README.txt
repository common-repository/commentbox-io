...
We provide a way to import Wordpress comments into CommentBox.io, which you can read about [here](https://commentbox.io/docs/dashboard#importing-comments). However, we do not link Wordpress users to CommentBox.io users.
